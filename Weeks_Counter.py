# WeeksLeftToLiveCounter by Dr.M_Dev
...
def restart():
    ...
    print("******** Weeks Left To Live Counter - By: Dr.m DEV*********")#
    # =================================================================
    print("note: don't take this test seriously, it's just a small fun project :)")
    ...
    input("press anything to start again :]")
    print("\n"*100)
    restart()
